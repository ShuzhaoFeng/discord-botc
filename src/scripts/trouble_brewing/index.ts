...
export const TROUBLE_BREWING: ScriptDefinition = {
  roles: [
    { ...washerwoman, category: "Townsfolk" },
    { ...librarian, category: "Townsfolk" },
    { ...investigator, category: "Townsfolk" },
    { ...chef, category: "Townsfolk" },
    { ...empath, category: "Townsfolk" },
    { ...fortune_teller, category: "Townsfolk" },
    { ...undertaker, category: "Townsfolk" },
    { ...monk, category: "Townsfolk" },
    { ...ravenkeeper, category: "Townsfolk" },
    { ...virgin, category: "Townsfolk" },
    { ...slayer, category: "Townsfolk" },
    { ...soldier, category: "Townsfolk" },
    { ...mayor, category: "Townsfolk" },
    { ...butler, category: "Outsider" },
    { ...drunk, category: "Outsider" },
    { ...recluse, category: "Outsider" },
    { ...saint, category: "Outsider" },
    { ...poisoner, category: "Minion" },
    { ...spy, category: "Minion" },
    { ...scarlet_woman, category: "Minion" },
    { ...baron, category: "Minion" },
    { ...imp, category: "Demon" },
  ],
};
